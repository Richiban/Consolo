...
public static class Program
{
    public static int Main(string[] args)
    {
        ...
        createBranchesCommand.Handler = CommandHandler.Create<System.String>(Cmdr.Samples.BranchActions.CreateBranches);
        ...
        addRemoteCommand.Handler = CommandHandler.Create<System.String, System.String>(Cmdr.Samples.SampleProgram.AddRemote);
        ...
        removeRemoteCommand.Handler = CommandHandler.Create<System.String>(Cmdr.Samples.SampleProgram.RemoveRemote);
        ...
        listRemotesCommand.Handler = CommandHandler.Create(Cmdr.Samples.SampleProgram.ListRemotes);
        ...
        rootCommand.Handler = CommandHandler.Create(Cmdr.Samples.Root.MainRoot);
