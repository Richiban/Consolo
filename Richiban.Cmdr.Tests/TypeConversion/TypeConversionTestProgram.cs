...
namespace Richiban.Cmdr.Tests.TypeConversion
{
    ...
    internal class TypeConversionTestProgram
    {
        ...
        public object StringTypeConversionAction(string param) =>
            new
            {
        ...
        public object EnumTypeConversionAction(TestEnum param) =>
            new
            {
        ...
        public object IntTypeConversionAction(int param) =>
            new
            {
        ...
        public object UriTypeConversionAction(Uri param) =>
            new
            {
        ...
        public object MissingTypeConversionAction(int param = 1) =>
            new
            {
