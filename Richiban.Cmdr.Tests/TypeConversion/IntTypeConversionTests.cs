...
{
    [TestFixture]
    internal class IntTypeConversionTests : CommandLineTest
    {
        [TestCase("1"), TestCase("0"), TestCase("100000")]
        public void IntTypeConversionTest(string testValue)
        {
            var result = RunTest("type-conversion-tests", "int", "-param", testValue)
                .ProgramOutput;
        ...
        [TestCase("x"), TestCase(""), TestCase("100.0")]
