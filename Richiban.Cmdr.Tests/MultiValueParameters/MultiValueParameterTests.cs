...
{
    internal class MultiValueParameterTests : CommandLineTest
    {
        [Test]
        public void MultipleIntParametersAreMappedToArray()
        {
            ...
            Assert.That(
                ...
                Is.EqualTo(nameof(TestProgram.MultiValueParameterAction)));
        ...
        public void ZeroStringParametersAreMappedToParamsArray()
        {
            ...
            Assert.That(
                result.ProgramOutput.ExecutedAction,
                Is.EqualTo(nameof(TestProgram.MultiValueParamsParameterAction)));

            Assert.That(
                result.ProgramOutput.Output,
                Is.EqualTo("{ nonParamsParam = zero, remainingParams = [] }"));
        }
        ...
        public void MultipleNamedStringParametersAreMappedToParamsArray()
        {
            ...
            Assert.That(
                result.ProgramOutput.Output,
                Is.EqualTo("{ nonParamsParam = z, remainingParams = [a, b, c] }"));
        }

        [Test]
        public void
            MultipleNamedStringParametersAreMappedToParamsArrayEvenWhenOutOfOrder()
        {
            var result = RunTest(
                "multi-value-params-param",
                "/remainingParams:a",
