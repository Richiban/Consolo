...
{
    [Test]
    public void MainMethodResultsInError()
    {
        var source = """
                     using Consolo;
        ...
        errors
            ...
            .ShouldSatisfyAllConditions(
                error => error.Id.ShouldBe("Consolo0014"),
                error => error.Severity.ShouldBe(DiagnosticSeverity.Error),
                error => error
                    .GetMessage()
                    .ShouldBe("In order to use Consolo your program must NOT define a Main method"),
                error => error
                    .Location.GetMappedLineSpan()
                    .ShouldSatisfyAllConditions(
                        loc => loc.StartLinePosition.Line.ShouldBe(6),
                        loc => loc.StartLinePosition.Character.ShouldBe(23),
                        loc => loc.EndLinePosition.Line.ShouldBe(6),
                        loc => loc.EndLinePosition.Character.ShouldBe(27)));
    }
    ...
    public void NoCommandsResultsInError()
    {
        ...
        error.ShouldSatisfyAllConditions(
            ...
            () => error
                .GetMessage()
                .ShouldBe("No command methods found. Make sure you're using the Consolo attribute."),
    ...
    public void IllegalAliasResultsInError(string aliasName)
    {
        ...
        diagnostics
            ...
            .ShouldSatisfyAllConditions(
                ...
                error => error
                    .GetMessage()
                    .ShouldBe("Parameter aliases must be a single character in the range [a-z]."),
    ...
    public void TwoParamsWithSameAliasResultsInError()
    {
        ...
        diagnostics
            ...
            .ShouldSatisfyAllConditions(
                ...
                error => error
                    .GetMessage()
                    .ShouldBe("The parameter name or alias 'a' is already in use in command 'TestMethod'."),
                error => error.Location.ShouldSatisfyAllConditions(
    ...
    public void TwoParamsWithSameNameResultsInError()
    {
        ...
        diagnostics
            ...
            .ShouldSatisfyAllConditions(
                ...
                error => error
                    .GetMessage()
                    .ShouldBe("The parameter name or alias 'p1' is already in use in command 'TestMethod'."),
                error => error.Location.ShouldSatisfyAllConditions(
